...
export module tool {
            ...
            var rootUl = <ul className="pagination pagination-sm bd-pagination" role="menubar" aria-label="Pagination">
                <li className={pagintionView.IsAbleBeforeLink ? "arrow" : "arrow disabled"}
                    ...
                    <a
                        ...
                        data-key={this.props.Vm.PageIndex - 1}
                        className={pagintionView.IsAbleBeforeLink ? "Hu-pointer" : ""}
                    >
                        <i className="icon-double-angle-left" data-key={this.props.Vm.PageIndex - 1}
                        ></i>
                    </a>
                </li>
                {
                    pagintionView.BeforList.map((a, i) => {
                        return <li key={i} className={a == this.props.Vm.PageIndex ? "active" : null}>
                ...
                <li className={pagintionView.IsAbleAfterList ? "arrow" : "arrow disabled"}>
                    ...
                    >
                        <i className="icon-double-angle-right" data-key={this.props.Vm.PageIndex + 1}></i>
                    </a>
                </li>
                ...
                <ul className="pagination pagination-sm pull-left" role="menubar" aria-label="Pagination">
                    <li className={pagintionView.IsAbleBeforeLink ? "arrow" : "arrow disabled"}
                        ...
                        <a
                            ...
                            className={pagintionView.IsAbleBeforeLink ? "Hu-pointer" : ""}
                        >
                            <i className="icon-double-angle-left fa fa-angle-double-left" data-key={this.props.Vm.PageIndex - 1}
                            ></i>
                        </a>
                    </li>
                    {
                    ...
                    <li className={pagintionView.IsAbleAfterList ? "arrow" : "arrow disabled"}>
                        <a onClick={(e) => {
                            ...
                            className={pagintionView.IsAbleAfterList ? "Hu-pointer" : ""}
                        >
                            <i className="icon-double-angle-right fa fa-angle-double-right" data-key={this.props.Vm.PageIndex + 1}></i>
                        </a>
                    </li>
    ...
    export class PaginationVm extends BaseColVm {
        ...
        //     @decorator.setDecoratorProps("何时使用", "", "◇ 当加载/渲染数据时花费很多时间时◇ 适应页面设计◇ 方便用户操作数据")
        public WUse: string;
        //    @decorator.setDecoratorProps("如何使用", "", "1.引入组件  import Pagination = require(\"./../../05tool/05tool/ Pagination\");")
        public HUse: string;
