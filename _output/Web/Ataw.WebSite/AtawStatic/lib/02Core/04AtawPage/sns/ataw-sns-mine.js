(function ($) {
    ...
    $.AKjs.MyHome = function ($mainDiv, $rightDiv, userId) {
        ...
        var param = Base64.encode("{\"keys\":\"" + $.AKjs.LoginId + "\"}");
        var _$userInfoDiv = $("<div class='sns_userinfo panel panel-default clearfix' style='min-height:30px'><div class='panel-heading'>个人资料( <a class='ACT-A-HREF' href='$$module/SNS/UserInfo/User_DetailUpdate$Update$"+
                            param + "'>编辑个人资料</a>)</div></div>");
