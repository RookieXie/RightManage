...
//Specify full URL to down and right arrow images (23 is padding-right for top level LIs with drop downs, 6 is for vertical top level items with fly outs):
    arrowimages: { down: ['downarrowclass', '/AtawStatic/lib/03Extend/ddsmoothmenu/down.gif', 23], right: ['rightarrowclass', '/AtawStatic/lib/03Extend/ddsmoothmenu/right.gif', 6] },
