...
(function ($) {
    ...
    _pG._generateTables = function (objP) {
        var that = this.that,thisColModel = that.colModel,noColumns = thisColModel.length,thisOptions = that.options,columnBorders = thisOptions.columnBorders,rowBorders = thisOptions.rowBorders,SM = thisOptions.scrollModel,outerWidths = that.outerWidths;
        that._bufferObj_calcInitFinal();
        var row = (objP) ? 0 : that.init,finalRow = (objP) ? objP.data.length - 1 : that["final"],data = (objP && objP.data) ? objP.data : that.data,offset = that.getRowIndxOffset();
        ...
        this.offsetRow = null;
        do {
            var rowObj = data[row],rowData = rowObj,rowIndx = row,hidden = rowData.hidden,row_str = "";
            if (hidden) {
                if (row == finalRow) {
                    break;
                }
    ...
    _pG._renderCell = function (objP) {
        var that = this.that,rowIndxPage = objP.rowIndxPage,rowIndx = objP.rowIndx,rowData = objP.rowData,colIndx = objP.colIndx,$td = objP.$td,column = objP.column,dataIndx = column.dataIndx,wrap = objP.wrap,
    ...
    _pG._generateRow = function (rowData, rowIndx, thisColModel, noColumns, hidearrHS1, offset, const_cls, buffer, objP) {
        ...
        var that = this.that,thisOptions = that.options,columnBorders = thisOptions.columnBorders,wrap = thisOptions.wrap,customData = thisOptions.customData;
        ...
        for (var col = 0; col < noColumns; col++) {
            var column = thisColModel[col],dataIndx = column.dataIndx;
    ...
    _p._addToData = function (objP) {
        ...
        var data = (location == "remote") ? this.that.data : this.options.dataModel.data,indx = (location == "remote") ? objP.rowIndxPage : objP.rowIndx,rowData = data[indx];
    ...
    _p.removeAll = function (objP) {
        ...
        var raiseEvent = objP.raiseEvent,that = this.that,offset = (objP.offset == null) ? that.getRowIndxOffset() : obj.offset;
    ...
    _p.replace = function (obj) {
        ...
        var rowIndx = obj.rowIndx,offset = obj.offset = (obj.offset == null) ? this.that.getRowIndxOffset() : obj.offset,rowIndxPage = obj.rowIndxPage = rowIndx - offset,$tr = obj.$tr,evt = obj.evt;
    ...
    _p.add = function (objP) {
        ...
        var rowIndx = objP.rowIndx,that = this.that,offset = (objP.offset == null) ? that.getRowIndxOffset() : objP.offset,rowIndxPage = objP.rowIndxPage = rowIndx - offset,$tr = objP.$tr,evt = objP.evt,selectedRows = this.selectedRows,isSelected = this.isSelected(objP);
        if (isSelected == null) {
            return false;
        }
        else if (this.isSelected(objP) == false) {
            var ret = this._boundRow(objP),$tr = ret;
    ...
    _p.remove = function (objP) {
        ...
        var rowIndx = objP.rowIndx,that = this.that,offset = (objP.offset == null) ? that.getRowIndxOffset() : objP.offset,rowIndxPage = objP.rowIndxPage = rowIndx - offset,evt = objP.evt,init = (that.init + offset - that.offsetRow),finall = (that['final'] + offset - that.offsetRow);
    ...
    _p.indexOf = function (obj) {
        ...
        var rowIndx = obj.rowIndx,selectedRows = this.selectedRows;
        for (var i = 0; i < selectedRows.length; i++) {
    ...
    _p._boundRow = function (obj) {
        var rowIndxPage = obj.rowIndxPage,rowIndx = obj.rowIndx,that = this.that,$tr = (obj.$tr == null) ? that.getRow({ rowIndxPage: rowIndxPage }) : obj.$tr;
    ...
    var cCells = function (that) {
        this.options = that.options,this.that = that,this.selectedCells = [];
    }
    ...
    _pC.removeAll = function (objP) {
        ...
        for (var i = 0; i < selectedCells.length; i++) {
            ...
            var rowIndx = selC.rowIndx,dataIndx = selC.dataIndx;
    ...
    _pC.isSelected = function (objP) {
        ...
        var location = this.options.dataModel.location;
        var that = this.that,data = (location == "remote") ? that.data : this.options.dataModel.data,indx = (location == "remote") ? objP.rowIndxPage : objP.rowIndx,dataIndx = (objP.dataIndx == null) ? that.colModel[objP.colIndx].dataIndx : objP.dataIndx,rowData = data[indx];
        if (rowData == null) {
            return null;
        }
        if (rowData.selectedDataIndices) {
    ...
    _pC.replace = function (obj) {
        ...
        var rowIndx = obj.rowIndx,colIndx = obj.colIndx,offset = obj.offset = (obj.offset == null) ? this.that.getRowIndxOffset() : obj.offset,rowIndxPage = obj.rowIndxPage = rowIndx - offset,$td = obj.$td,evt = obj.evt;
        this.removeAll({ raiseEvent: true });
        this.add(obj);
    }
    _pC.add = function (objP) {
        ...
        var rowIndx = objP.rowIndx,that = this.that,offset = (objP.offset == null) ? that.getRowIndxOffset() : objP.offset,rowIndxPage = objP.rowIndxPage = rowIndx - offset,colIndx = objP.colIndx = (objP.colIndx == null) ? that.getColIndxFromDataIndx(objP.dataIndx) : objP.colIndx,dataIndx = objP.dataIndx = (objP.dataIndx == null) ? that.colModel[colIndx].dataIndx : objP.dataIndx,evt = objP.evt,selectedCells = this.selectedCells,isSelected = this.isSelected(objP);
        if (isSelected == null) {
            return false;
        }
    ...
    _pC.indexOf = function (obj) {
        ...
        var rowIndx = obj.rowIndx,that = this.that,dataIndx = obj.dataIndx = (obj.dataIndx == null) ? that.colModel[obj.colIndx].dataIndx : obj.dataIndx;
    ...
    fn._findCellFromEvtCoords = function (evt) {
        ...
        var indx = 0,rowIndxPage = 0,colIndx = 0;
    ...
    fn._rangeSelectRow = function (initRowIndx, finalRowIndx, evt) {
        var that = this,rowSelection = that.sRows.getSelection(),rowSelection2 = rowSelection.slice(0);
    ...
    fn._rangeSelect = function (initRowIndx, initColIndx, finalRowIndx, finalColIndx, evt) {
        var that = this,cellSelection = that.sCells.getSelection(),cellSelection2 = cellSelection.slice(0);
        for (var i = 0; i < cellSelection2.length; i++) {
            var cellS = cellSelection2[i],row = cellS.rowIndx,dataIndx = cellS.dataIndx,col = this.getColIndxFromDataIndx(dataIndx);
            if (row < initRowIndx || row > finalRowIndx) {
    ...
    fn._onDblClickCell = function (evt) {
        ...
        var rowIndxPage = obj.rowIndxPage,offset = that.getRowIndxOffset(),rowIndx = rowIndxPage + offset,colIndx = obj.colIndx;
        ...
        if (selectionModel.type == 'row') {
            ...
            if (rowSelection.length > 0) {
                if (evt.ctrlKey && selectionModel.mode != 'single') {
                    ...
                    var rowS = rowSelection[rowSelection.length - 1],rowIndx1 = rowS.rowIndx,initRowIndx = rowIndx1,finalRowIndx = rowIndx;
                    if (rowIndx1 > rowIndx) {
                        initRowIndx = rowIndx;
                    ...
                    for (var i = 0; i < rowSelection2.length; i++) {
                        var rSel = rowSelection2[i],row = rSel.rowIndx;
                        if (row < initRowIndx || row > finalRowIndx) {
    ...
    fn.isEditableCell = function (obj) {
        var colIndx = obj.colIndx,column = (obj.column == null) ? (this.colModel[colIndx]) : obj.column,editable = true;
    ...
    fn._onClickCell = function (evt) {
        var that = this,thisOptions = this.options,selectionModel = thisOptions.selectionModel;
        ;
        var $td = $(evt.currentTarget);
        var objP = that.getCellIndices($td);
        var rowIndxPage = objP.rowIndxPage,offset = that.getRowIndxOffset(),rowIndx = objP.rowIndx = rowIndxPage + offset,colIndx = objP.colIndx,dataIndx = objP.dataIndx = this.colModel[colIndx].dataIndx,column = that.colModel[colIndx];
        objP.evt = evt;
        ...
        if (selectionModel.type == 'cell') {
            ...
            if (cellSelection.length > 0) {
                if (evt.ctrlKey && selectionModel.mode != 'single') {
                    ...
                    var cellS = cellSelection[cellSelection.length - 1],rowIndx1 = cellS.rowIndx,colIndx1 = that.getColIndxFromDataIndx(cellS.dataIndx),initRowIndx = rowIndx1,finalRowIndx = rowIndx,initColIndx = colIndx1,finalColIndx = colIndx;
                    if (rowIndx1 > rowIndx) {
                        initRowIndx = rowIndx;
                        finalRowIndx = rowIndx1;
                    }
    ...
    fn._refreshDataFromDataModel = function () {
        var thisOptions = this.options,DM = thisOptions.dataModel;
    ...
    fn._refreshSortingDataAndView = function (obj) {
        var sorting = obj.sorting,fn = obj.fn,keepSelection = obj.keepSelection;
        if (!keepSelection) {
        ...
        var DM = this.options.dataModel,thisColModel = this.colModel,indx = DM.sortIndx,colIndx = this.getColIndxFromDataIndx(indx);
    ...
    fn._computeOuterWidths = function (basedOnWidthsOnly) {
        var options = this.options,columnBorders = options.columnBorders,thisColModel = this.colModel,thisColModelLength = thisColModel.length;
    ...
    fn._generateCellRowOutline = function (obj) {
        var $td = obj.$td,$tr = obj.$tr,that = this;
        if ($tr) {
    ...
    fn._generateCellHighlighter = function (offsetParent, lft, top, wd, ht) {
        if (this.$div_focus && this.$div_focus[0].offsetParent == offsetParent) {
            ...
            if (this.$div_focus)
                this.$div_focus.remove();
            this.$div_focus = $("<div class='pq-cell-selected-border'></div>").appendTo(offsetParent);
            this.$div_focus.css({
                left: lft,
                top: top,
                height: ht,
    ...
    fn.selectRow = function (obj) {
        var rowIndx = obj.rowIndx,evt = obj.evt,offset = obj.offset;
    ...
    fn.bringRowIntoView = function (obj) {
        ...
        if ($tr[0] == undefined) {
            ...
            var td_bottom = $tr[0].offsetTop + $tr[0].offsetHeight,htCont = this.$cont[0].offsetHeight,htSB = this._getScollBarHorizontalHeight();
    ...
    fn._bringCellIntoView = function (obj) {
        var rowIndxPage = obj.rowIndxPage,colIndx = obj.colIndx,tdneedsRefresh = false;
        var $td;
    ...
    fn.selection = function (obj) {
        var rowIndx = obj.rowIndx,colIndx = obj.colIndx,method = obj.method,type = obj.type;
        if (type == 'row') {
    ...
    fn._setSelection = function (obj) {
        ...
        var offset = obj.offset = (obj.offset == null) ? this.getRowIndxOffset() : obj.offset,rowIndx = obj.rowIndx = (obj.rowIndx == null) ? obj.rowIndxPage + offset : obj.rowIndx,rowIndxPage = obj.rowIndxPage = (obj.rowIndxPage == null) ? obj.rowIndx - offset : obj.rowIndxPage,colIndx = obj.colIndx,evt = obj.evt;
    ...
    fn.saveEditCell = function () {
        if (this.$td_edit == null)
            return;
        var $td = this.$td_edit,obj = this.getCellIndices($td),offset = this.getRowIndxOffset(),colIndx = obj.colIndx,rowIndxPage = obj.rowIndxPage,rowIndx = obj.rowIndx = rowIndxPage + offset,thisColModel = this.colModel,column = obj.column = thisColModel[colIndx],dataIndx = obj.dataIndx = column.dataIndx,prevVal = this.data[rowIndxPage][dataIndx];
        if (rowIndxPage != null) {
    ...
    fn.refreshColumn = function (obj) {
        var customData = this.options.customData,colIndx = obj.colIndx = (obj.colIndx == null) ? this.getColIndxFromDataIndx(obj.dataIndx) : obj.colIndx,offset = this.getRowIndxOffset();
    ...
    fn.refreshCell = function (obj) {
        if (!this.data)
            return;
        var offset = obj.offset = (obj.offset == null) ? this.getRowIndxOffset() : obj.offset,rowIndx = obj.rowIndx = (obj.rowIndx == null) ? obj.rowIndxPage + offset : obj.rowIndx,rowIndxPage = obj.rowIndxPage = (obj.rowIndxPage == null) ? obj.rowIndx - offset : obj.rowIndxPage,dataIndx = obj.dataIndx,colIndx = obj.colIndx = (obj.colIndx == null) ? this.getColIndxFromDataIndx(dataIndx) : obj.colIndx,$td = obj.$td = (obj.$td == null) ? this.getCell(obj) : obj.$td,column = obj.column = this.colModel[colIndx],rowData = this.data[rowIndxPage];
        if (!rowData)
            return;
        var objRender = obj;
    ...
    fn.refreshRow = function (obj) {
        if (!this.data)
            return;
        var thisOptions = this.options,offset = obj.offset = (obj.offset == null) ? this.getRowIndxOffset() : obj.offset,rowIndx = obj.rowIndx = (obj.rowIndx == null) ? obj.rowIndxPage + offset : obj.rowIndx,rowIndxPage = obj.rowIndxPage = (obj.rowIndxPage == null) ? obj.rowIndx - offset : obj.rowIndxPage,$tr = (obj.$tr == null) ? this.getRow(obj) : obj.$tr,thisColModel = this.colModel,rowData = this.data[rowIndxPage];
        if (!rowData)
            return;
    ...
    fn.getRowIndxOffset = function () {
        var DM = this.options.dataModel,paging = DM.paging,offset = 0;
    ...
    fn.selectCell = function (obj) {
        var rowIndx = obj.rowIndx,colIndx = obj.colIndx,evt = obj.evt;
        if (evt && (evt.type == "keydown" || evt.type == "keypress")) {
    ...
    fn._editCell = function ($td) {
        var that = this;
        var obj = that.getCellIndices($td);
        var rowIndxPage = obj.rowIndxPage,offset = this.getRowIndxOffset(),rowIndx = rowIndxPage + offset,colIndx = obj.colIndx,column = this.colModel[colIndx],dataIndx = column.dataIndx;
        if (this.$td_edit && this.$td_edit[0] == $td[0]) {
            return false;
        }
        this.$td_edit = $td;
    ...
    fn.getCell = function (obj) {
        var rowIndxPage = (obj.rowIndxPage == null) ? (obj.rowIndx - this.getRowIndxOffset()) : obj.rowIndxPage,colIndx = obj.colIndx;
        var $td;
        if (this.$tbl != undefined)
    ...
    fn._getEditCellData = function (obj) {
        var colIndx = obj.colIndx,rowIndxPage = obj.rowIndxPage,rowIndx = (obj.rowIndx != null) ? obj.rowIndx : rowIndxPage + this.getRowIndxOffset(),column = (obj.column) ? obj.column : this.colModel[colIndx],$cell = (obj.$cell) ? obj.$cell : this.$div_focus;
    ...
    fn._incrRowIndx = function (rowIndxPage, noRows) {
        var newRowIndx = rowIndxPage,noRows = (noRows == null) ? 1 : noRows,counter = 0;
    ...
    fn.addColumn = function (column, columnData) {
        var thisOptions = this.options,thisOptionsColModel = thisOptions.colModel,data = thisOptions.dataModel.data;
    ...
    fn.keyPressDown = function (evt) {
        var that = this,selectedCells = this.sCells.getSelection(),selectedRows = this.sRows.getSelection(),offset = that.getRowIndxOffset(),selectionModel = that.options.selectionModel,rowIndx, colIndx;
        var keyCodes = {
            left: 37,
            up: 38,
            right: 39,
        ...
        if (that.$td_edit) {
            ...
            var obj = that.getCellIndices($td),rowIndxPage = obj.rowIndxPage,rowIndx = rowIndxPage + offset,colIndx = obj.colIndx,column = this.colModel[colIndx],colSaveKey = (column.editModel) ? column.editModel.saveKey : null;
            ...
            if (selectedCells.length > 0 && selectionModel.type == 'cell') {
                var obj = selectedCells[selectedCells.length - 1],
                        rowIndx = obj.rowIndx,rowIndxPage = rowIndx - offset,dataIndx = obj.dataIndx,colIndx = this.getColIndxFromDataIndx(dataIndx);
    ...
    fn._setScrollVNumEles = function (fullRefresh) {
        var that = this,$vscroll = this.$vscroll,options = $vscroll.pqScrollBar("option"),num_eles = parseInt(options.num_eles),cur_pos = parseInt(options.cur_pos);
    ...
    fn._setInnerGridHeight = function () {
        if (this.options.flexHeight)
            return;
        var ht = (this.element.height() -((this.options.topVisible) ? this.$top[0].offsetHeight : 0) -((this.options.bottomVisible) ? this.$bottom[0].offsetHeight : 0));
    ...
    fn._bufferObj_calcInitFinalH = function () {
        ...
        var initH = 0;
        var indx = 0,thisColModel = this.colModel;
    ...
    fn.getHeadersCells = function () {
        var optColModel = this.options.colModel,thisColModelLength = this.colModel.length,depth = this.depth;
        var arr = [];
    ...
    fn.assignRowSpan = function () {
        var optColModel = this.options.colModel,thisColModelLength = this.colModel.length,headerCells = this.headerCells,depth = this.depth;
        for (var col = 0; col < thisColModelLength; col++) {
            for (var row = 0; row < depth; row++) {
    ...
    fn._createHeader = function () {
        ...
        var hidearrHS1 = [];
        var thisOptions = this.options,optColModel = thisOptions.colModel,optColModelLength = optColModel.length,thisColModel = this.colModel,thisColModelLength = thisColModel.length,depth = this.depth,columnBorders = thisOptions.columnBorders,headerCells = this.headerCells;
        if (depth >= 1) {
            str += "<tr>";
            if (this.numberCell) {
        ...
        for (var row = 0; row < depth; row++) {
            ...
            for (var col = 0; col < thisColModelLength; col++) {
                ...
                str += "<td " + colIndx + " " + dataIndx + " class='" + cls + "' rowspan=" + column.rowSpan + " colspan=" + colSpan + ">\				<div class='pq-grid-header-table-div' >" +column.title +"<span class='pq-col-sort-icon'>&nbsp;</span></div></td>";
            }
            str += "</tr>";
        }
        str += "</table>";
    ...
    fn._generateSummaryRow = function (rowData, rowIndx, thisColModel, noColumns, hidearrHS1, offset, const_cls, buffer) {
        var row_cls = "pq-summary-row",row_str = "",columnBorders = this.options.columBorders;
    ...
    fn._refreshOtherTables = function () {
        return;
        var thisColModel = this.colModel,noColumns = thisColModel.length,columnBorders = this.options.columBorders;
        for (var i = 0; i < this.tables.length; i++) {
            var tblObj = this.tables[i];
            var $tbl = tblObj.$tbl,$tr = $tbl.find("tr:first");
            for (var col = 0; col < noColumns; col++) {
                var column = thisColModel[col],dataIndx = column.dataIndx;
                if (column.hidden) {
